...
Location: /2.3/orders/ec4bc754-6a30-11e2-a585-4fc569183061
Content-Type: application/json

{
    "path": "/pubapi.php/2.3/orders/ec4bc754-6a30-11e2-a585-4fc569183061",
    "accessId": "STTA0001",
    "service": "BB-100-10",
    "operation": "ACTIVATE",
    "state": "RECEIVED",
...
Request:
```http
GET /2.3/orders/ec4bc754-6a30-11e2-a585-4fc569183061 HTTP/1.1
```
